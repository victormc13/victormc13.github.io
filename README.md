...
**[Portfolio-project]** is a created portfolio in Microverse to know more about me
...
- **[UI design implemented from a Figma template]**
- **[Correct set up linters]**
...
```sh
  cd my-folder
  git clone https://github.com/victormc13/Portfolio-project.git
```
...
Feel free to check the [issues page](https://github.com/victormc13/Hello-world/issues).
